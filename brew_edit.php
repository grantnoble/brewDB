...
<fieldset class="fieldset col-xs-12 col-md-12 five-ingredients">
	...
	for ($i=0; $i<=4; $i++)
	{
		if ($mashes[$i]['temp'] || $mashes[$i]['time'])
		{
			...
			echo '<div class="col-xs-3 col-sm-2 col-md-1">';
			echo '<input type="number" class="form-control input-sm" name="mash' . $i . '_temp" value="' . $mashes[$i]['temp'] . '"/> ';
			echo '</div>';
...
<fieldset class="fieldset col-xs-12 col-md-12 five-ingredients">
	...
	for ($i=0; $i<=4; $i++)
	{
		if ($fermentations[$i]['start_date'] || $fermentations[$i]['end_date'] || $fermentations[$i]['temp'] || $fermentations[$i]['measured_sg'])
		{
			...
			echo '<div class="col-xs-3 col-sm-2 col-md-2">';
			echo '<input type="date" class="form-control input-sm" name="fermentation' . $i . '_start_date" value="' . $fermentations[$i]['start_date'] . '"/> ';
			echo '</div>';

			echo '<div class="hidden-xs col-sm-2 col-md-2">';
			echo '<input type="date" class="form-control input-sm" name="fermentation' . $i . '_end_date" value="' . $fermentations[$i]['end_date'] . '"/> ';
			echo '</div>';

			echo '<div class="hidden-xs col-sm-2 col-md-1">';
			echo '<input type="number" class="form-control input-sm" min="0" step="0.1" name="fermentation' . $i . '_temp" value="' . $fermentations[$i]['temp'] . '"/> ';
			echo '</div>';
