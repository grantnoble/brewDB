<?php
/*
brew_get_details.php
Selects all the brew, recipe, style, fermentable, hop, yeast, misc, mash, and fermentation details for a brew ID.
Included in brew_view, brew_edit, and brew_delete.php files.
*/
