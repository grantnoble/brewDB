...
{
	$query = "SELECT brew_id, brew_name, brew_type, brew_date, style_guide, style_category, style_subcategory, style_name FROM brews INNER JOIN styles ON brew_style_id=style_id ORDER BY style_category_number, style_subcategory, brew_date";
}
elseif ($sortby=='style_name')
{
	$query = "SELECT brew_id, brew_name, brew_type, brew_date, style_guide, style_category, style_subcategory, style_name FROM brews INNER JOIN styles ON brew_style_id=style_id ORDER BY style_name, brew_date";
}
else
{
	$query = "SELECT brew_id, brew_name, brew_type, brew_date, style_guide, style_category, style_subcategory, style_name FROM brews INNER JOIN styles ON brew_style_id=style_id ORDER BY brew_date DESC";
}
...
echo '<tr class="info"> <th>Brew Name</th><th><a href="brews_list.php?id=category">BJCP Category</a></th><th><a href="brews_list.php?id=style_name">Style Name</a></th><th>Brew Type</th> <th><a href="brews_list.php?id=date">Date</a></th></tr>';
