		...
		<legend>Brew Details</legend>
			...
			<div class="row margin-bottom-1em">
				...
				<div class="col-xs-3 col-md-4">
					<label for="method" class="label-sm">Brew Method</label>
					<input type="text" class="form-control input-sm" id="method" name="method" readonly="yes" value="<?php echo $details['method']; ?>" />
				</div>
