...
<div class="container">
	...
	<form role="form" name="fermentableform" action="fermentable_edit.php" method="post">
...
<form role="form" name="fermentableformedit" action="fermentable_edit.php" method="get">
