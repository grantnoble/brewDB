...
<div class="container">
	...
	<form role="form" name="styleform" data-toggle="validator" action="style_new.php" method="post">
		...
		<div class="well">
			...
			<div class="row">
				...
				<div class="form-group col-xs-4 col-md-2">
					...
					<select class="form-control input-sm" id="style_guide" name="style_guide" required data-error="Style Guide required" >
				...
				<div class="form-group col-xs-3 col-md-2">
					...
					<input type="text" class="form-control input-sm" id="category_number" name="category_number" required data-error="Cat. number required" />
					<div class="help-block with-errors"></div>
				</div>

				<div class="form-group col-xs-3 col-md-2">
					<label for="style_letter" class="label-sm">Letter</label>
					<input type="text" class="form-control input-sm" id="style_letter" name="style_letter" required data-error="Style letter required" />
					<div class="help-block with-errors"></div>
				</div>
			...
			<div class="row">
				...
				<div class="form-group col-xs-4 col-md-4">
					...
					<input type="text" class="form-control input-sm" id="category" name="category" required data-error="Category required" />
					<div class="help-block with-errors"></div>
				</div>

				<div class="form-group col-xs-4 col-md-4">
					<label for="name" class="label-sm">Style Name</label>
					<input type="text" class="form-control input-sm" id="name" name="name" required data-error="Style name required" />
					<div class="help-block with-errors"></div>
				</div>

				<div class="form-group col-xs-4 col-md-2">
					<label for="type" class="label-sm">Style Type</label>
					<input type="text" class="form-control input-sm" id="type" name="type" required data-error="Style type required" />
					<div class="help-block with-errors"></div>
				</div>
			...
			<div class="row">
				...
				<div class="form-group col-xs-6">
					...
					<textarea class="form-control input-sm" rows="2" id="notes" name="notes"></textarea>
				</div>

				<div class="form-group col-xs-6">
					<label for="profile" class="label-sm">Profile</label>
					<textarea class="form-control input-sm" rows="2" id="profile" name="profile"></textarea>
				</div>
