...
recipe_date date,
recipe_est_og float(5,3),
recipe_est_fg float(5.3),
recipe_est_color float,
recipe_est_ibu float,
recipe_est_abv float(3,1),
...
brew_est_og float(5,3),
brew_act_og float(5,3),
brew_est_fg float(5,3),
brew_act_fg float(5,3),
brew_est_color float,
brew_est_ibu float,
brew_est_abv float(3,1),
brew_act_abv float(3,1),
...
brew_fermentation_measured_sg float(5,3),
