...
/* 
yeasts_xml_load.php
Load yeasts details from an XML file into the database
*/
...
for ($i=0; $i<=count($array)-1; $i++)
  ...
  elseif ($array[$i]['level'] == 3)
    {
    if (($array[$i]['tag'] == 'NAME') || ($array[$i]['tag'] == 'VERSION') || ($array[$i]['tag'] == 'TYPE') || ($array[$i]['tag'] == 'FORM') || ($array[$i]['tag'] == 'LABORATORY') || ($array[$i]['tag'] == 'PRODUCT_ID') || ($array[$i]['tag'] == 'MIN_TEMPERATURE') || ($array[$i]['tag'] == 'MAX_TEMPERATURE') || ($array[$i]['tag'] == 'FLOCCULATION') || ($array[$i]['tag'] == 'ATTENUATION') || ($array[$i]['tag'] == 'NOTES') || ($array[$i]['tag'] == 'BEST_FOR') || ($array[$i]['tag'] == 'MAX_REUSE'))
    {
	$column .= $prefix;
